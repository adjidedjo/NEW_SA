class Order::Samarinda::SamarindaLadyController < ApplicationController
  include RolesHelper
  before_action :initialize_brand, :initialize_brach_id, :authorize_users, :order_daily
  ...
  def authorize_users
    ...
    bm(current_user, 54, "LADY") || sales(current_user, 54, "LADY")
  end
end