class Penjualan::Kediri::KediriSerenityController < ApplicationController
  include RolesHelper
  ...
  def authorize_user
    ...
    bm_customers(current_user, initialize_brach_id) || sales(current_user, initialize_brach_id, initialize_brand)
  end
end
