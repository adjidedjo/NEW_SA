class PenjualanDirect::NasionalEcom::NasionalSerenityController < ApplicationController
  include RolesHelper
  before_action :initialize_brand, :authorize_user, :checking_params
  before_action :direct_ecom_nasional_weekly, only: :weekly
  before_action :direct_ecom_nasional_monthly, only: :monthly
