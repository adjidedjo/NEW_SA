class PenjualanDirect::Nasional::NasionalElitesController < ApplicationController
  include RolesHelper
  ...
  before_action :direct_nasional_this_month, only: :daily
